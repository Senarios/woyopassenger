...
class RatingScreen extends StatefulWidget {
  ...
  final DatabaseReference rideReqRef;

  RatingScreen({this.driverId, this.rideReqRef});
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      widget.rideReqRef
                          ...
                          .set(feedbackTextController.text.toString());

                      print("val "+widget.rideReqRef.toString());
